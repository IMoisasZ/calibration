...
![PUT Localization](./src/assets/update_localization.PNG)

---

## 📄 Listar Localizações — GET /api/localization?status=true

![GET Localization](./src/assets/get_localization.PNG)
...
![POST Owner](./src/assets/create_owner.PNG)

---

## 📋 Listar Proprietários — GET /api/owner?status=true

![GET Owner](./src/assets/get_owner.PNG)
